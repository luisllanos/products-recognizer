# -*- coding: utf-8 -*-
# USAGE
# python buscar_producto.py --db productos.csv --empaques empaque 
# python buscar_producto.py --db productos.csv --empaques empaque --video 
...
while True:
	...
	# otherwise, matches were found
		...
		cv2.putText(frame, str(title), (40, 40), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (155, 155, 155), 2)
